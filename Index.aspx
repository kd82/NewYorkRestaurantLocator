...
<body>
    ...
    <section id="portfolio" class="portfolio">
        <div class="container">
            <div class="row">
                <div class="col-lg-10 col-lg-offset-1 text-center">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="portfolio-item">
                                <a href="http://localhost:5354/WebForm2.aspx" target="_blank">
                    ...
                    <div class="col-md-6">
                        <div class="portfolio-item">
                            <a href="http://localhost:5354/Geocode.aspx" target="_blank">
                ...
                <div class="col-md-6">
                    <div class="portfolio-item">
                        <a href="http://localhost:5354/Update.aspx" target="_blank">
            ...
            <div class="col-md-6">
                <div class="portfolio-item">
                    <a href="http://localhost:5354/Insert.aspx" target="_blank">
        ...
        <div class="col-md-6">
            <div class="portfolio-item">
                <a href="http://localhost:5354/SearchWithin.aspx" target="_blank">
