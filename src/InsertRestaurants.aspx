<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InsertRestaurants.aspx.cs" Inherits="WebApplication1.Geocode" %>
...
<body style="background-image: url(../img/bg_1.jpg); height: 100%; width: 100%; background-size: cover;">
    <form id="form1" runat="server">
        ...
        <div style="color: wheat; margin: 0%; margin-left: -3%; padding: 7%;">
            <p style="font-size: 19px; font-family: cursive; color: aliceblue;">
                Insert the Restaurant's data
            </p>
            <br />
            <br />
            Name  
